...
'use strict';
import { StringUtils, TokenCacheContext, AccountEntity } from '@azure/msal-common';
import { Deserializer } from './serializer/Deserializer.esm.js';
import { Serializer } from './serializer/Serializer.esm.js';
...
class TokenCache {
    ...
    async getAccountByLocalId(localAccountId) {
        const allAccounts = await this.getAllAccounts();
        if (!StringUtils.isEmpty(localAccountId) &&
            allAccounts &&
            allAccounts.length) {
...
export { TokenCache };
//# sourceMappingURL=TokenCache.esm.js.map
