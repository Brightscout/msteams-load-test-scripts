...
'use strict';
import { ClientApplication } from './ClientApplication.esm.js';
import { ClientAssertion } from './ClientAssertion.esm.js';
import { REGION_ENVIRONMENT_VARIABLE, ApiId, Constants as Constants$1 } from '../utils/Constants.esm.js';
import { OIDC_DEFAULT_SCOPES, UrlString, AADAuthorityConstants, ClientAuthError, AuthError, StringUtils, Constants } from '@azure/msal-common';
import { ClientCredentialClient } from './ClientCredentialClient.esm.js';
import { OnBehalfOfClient } from './OnBehalfOfClient.esm.js';
...
class ConfidentialClientApplication extends ClientApplication {
    ...
    setClientCredential(configuration) {
        ...
        const certificateNotEmpty = !StringUtils.isEmpty(certificate.thumbprint) ||
...
//# sourceMappingURL=ConfidentialClientApplication.esm.js.map
