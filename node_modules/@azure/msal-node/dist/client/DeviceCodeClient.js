...
class DeviceCodeClient extends msalCommon.BaseClient {
    ...
    createQueryString(request) {
        ...
        if (!msalCommon.StringUtils.isEmpty(request.claims) ||
    ...
    continuePolling(deviceCodeExpirationTime, userSpecifiedTimeout, userSpecifiedCancelFlag) {
        if (userSpecifiedCancelFlag) {
            ...
            throw msalCommon.ClientAuthError.createDeviceCodeCancelledError();
        }
            ...
            throw msalCommon.ClientAuthError.createUserTimeoutReachedError();
        }
            ...
            throw msalCommon.ClientAuthError.createDeviceCodeExpiredError();
        }
        return true;
    }
    /**
    ...
    async acquireTokenWithDeviceCode(request, deviceCodeResponse) {
        ...
        while (this.continuePolling(deviceCodeExpirationTime, userSpecifiedTimeout, request.cancel)) {
            ...
            if (response.body && response.body.error) {
                ...
                if (response.body.error === msalCommon.Constants.AUTHORIZATION_PENDING) {
                    ...
                    throw msalCommon.ServerError.createPostRequestFailed(response.body.error);
                }
            }
            else {
        ...
        throw msalCommon.ClientAuthError.createDeviceCodeUnknownError();
    }
    /**
