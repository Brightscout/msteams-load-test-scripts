...
var ClientApplication = require('./ClientApplication.js');
var ClientAssertion = require('./ClientAssertion.js');
var Constants = require('../utils/Constants.js');
var msalCommon = require('@azure/msal-common');
var ClientCredentialClient = require('./ClientCredentialClient.js');
var OnBehalfOfClient = require('./OnBehalfOfClient.js');
...
class ConfidentialClientApplication extends ClientApplication.ClientApplication {
    ...
    async acquireTokenByClientCredential(request) {
        ...
        if (Object.values(msalCommon.AADAuthorityConstants).includes(tenantId)) {
            throw msalCommon.ClientAuthError.createMissingTenantIdError();
        }
    ...
    setClientCredential(configuration) {
        ...
        const certificateNotEmpty = !msalCommon.StringUtils.isEmpty(certificate.thumbprint) ||
            !msalCommon.StringUtils.isEmpty(certificate.privateKey);
        /*
...
//# sourceMappingURL=ConfidentialClientApplication.js.map
