...
class OnBehalfOfClient extends msalCommon.BaseClient {
    ...
    async getCachedAuthenticationResult(request) {
        ...
        if (!cachedAccessToken) {
            ...
            throw msalCommon.ClientAuthError.createRefreshRequiredError();
        }
        ...
        if (cachedIdToken) {
            idTokenObject = new msalCommon.AuthToken(cachedIdToken.secret, this.config.cryptoInterface);
    ...
    readAccessTokenFromCacheForOBO(clientId, request) {
        ...
        if (numAccessTokens < 1) {
            ...
            throw msalCommon.ClientAuthError.createMultipleMatchingTokensInCacheError();
        }
